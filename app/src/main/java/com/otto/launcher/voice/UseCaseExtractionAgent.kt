...
internal class UseCaseExtractionAgent {
    suspend fun extract(transcript: String): List<UseCaseCandidate> {
        ...
        return GroqClient.chatJson(systemPrompt, userPrompt)
            .map { parsed -> parseUseCases(parsed.toString()) }
