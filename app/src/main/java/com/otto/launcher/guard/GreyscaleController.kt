...
internal fun Context.isGreyscaleEnabled(): Boolean {
...
internal fun Context.setGreyscaleEnabled(enabled: Boolean): Boolean {
...
internal fun Context.openGreyscaleSettings(): Boolean {
    val intents = listOf(
